...
public class FirstToBottom extends Minigame {
  ...
  //Constructor
  public FirstToBottom(int id, DConsole dc, ArrayList<Player> playerList) {
    super(id, dc, playerList, "Race 3");
    this.dc = dc;
  }

  //Entities
  private void addEntities(){
    super.entityList.add(new Entity(0, "finish line", 400.0, 530.0, 850.0, 40.0, true, Color.GREEN, this.dc));
  }

  //Set player spawn and size
  private void spawnPlayers() {
    playerList.get(0).setPOS(160, 30);
    playerList.get(1).setPOS(320, 30);
    playerList.get(2).setPOS(480, 30);
    playerList.get(3).setPOS(640, 30);
